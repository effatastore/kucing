...
Isadmin=$(curl -sS https://raw.githubusercontent.com/effatastore/taikucing/main/mek | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/effatastore/taikucing/main/mek | grep $MYIP | awk '{print $3}')
fi
...
echo -e "└──────────────────────────────────────────┘" | lolcat
echo -e "\033[1;96m  Owner        : EFFATA ID STORE \e[0m"
echo -e "\033[1;96m  Contact WA   : 081391215759 \e[0m"
echo -e "\033[1;96m  Telegram     : t.me/CRSe7en2nd \e[0m"
echo -e "\033[1;96m  Official     : t.me/vpnpremiumeffataidstore \e[0m"
